...
using ArviZ, Distributions, PrettyTables
...
::: fragment
Let's think about Cholesky factors really quick
:::

::: fragment
Andre Cholesky 
![](images/clipboard-3375023326.png)
:::
...
What's neat is that the Jacobian is "easy", put those bounds into our constraining function like `tanh()` or use the upper-lower bound transform to satisfy the constraints. That's it. 
...
This is a bit more stable than what's in the paper but also more opaque. The `exp()`'s here are just calculating stuff on the log-scale. Line 13 I take the log and try to stick with this as much as possible.
